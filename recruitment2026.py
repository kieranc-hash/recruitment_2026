...
other_activities = {
    ...
    "Playing a Percussion Instrument (drums, piano, etc.)": PlayingaPercussionInstrument,
    "Playing a String Instrument (violin, cello, etc.)": PlayingaStringInstrument,
    "Playing a Wind Instrument (flute, clarinet, etc.)": PlayingaWindInstrument,
    "Podcasts": Podcasts,
