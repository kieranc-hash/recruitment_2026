...
selected_physical_activities = checkbox_columns("Activities/Interests for Fun"+"\U0001F3C3", list(physical_activities.keys()), num_cols=4)
...
selected_interests = selected_majors + selected_minors + selected_colleges + selected_hometowns + selected_sports + selected_orgs + selected_clubs + selected_summercamps + selected_philanthropy + selected_physical_activities + selected_music + selected_books #+ selected_schools + selected_extras + selected_orgs + selected_activities + selected_summercamps + selected_nicheinterests + selected_transfers
